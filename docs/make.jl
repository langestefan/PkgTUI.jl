...
DocMeta.setdocmeta!(PkgTUI, :DocTestSetup, :(using PkgTUI); recursive = true)
...
makedocs(;
    ...
    repo = "https://github.com/langestefan/PkgTUI.jl/blob/{commit}{path}#{line}",
    sitename = "PkgTUI.jl",
    format = Documenter.HTML(; canonical = "https://langestefan.github.io/PkgTUI.jl"),
    pages = list_pages(),
)

deploydocs(; repo = "github.com/langestefan/PkgTUI.jl")
